...
def user_page():
    ...
    captured_us_state_codes = [
        state_abbreviations[state.name]
        for state in us_states
        if state.id in user_states and state.name in state_abbreviations
    ]

    return render_template('user_page.html', 
                           us_states=us_states,
                           captured_us_state_codes=captured_us_state_codes, 
